                        ...
                        <center>
                            <li class="nav-item menu dropdown">
                                ...
                                <ul class="dropdown-menu drop-ul">
                                    ...
                                    <li>
                                        <a class="drop-li" href="<?php echo base_url('/colegiados/'.$listacolegiado->id.'/'.$listacolegiado->sigla) ?>"> <strong><?php echo $listacolegiado->sigla ?> </strong> <br> <?php echo $listacolegiado->nome?> <hr></a>
                                    </li>
                                    <br><hr>
                                    <?php }?>
                                </ul>    
